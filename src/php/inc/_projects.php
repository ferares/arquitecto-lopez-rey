...
$projects = array(
  ...
  array(
    'name' => 'Taller Scalone',
    'location' => 'Punta del Este',
    'prefix' => 'Taller_Scalone',
    'imgCount' => 2,
  ),
  array(
    'name' => 'Residencia Son Pura',
    'location' => 'Punta del Este',
    'prefix' => 'Rcia_Son_Pura',
    'imgCount' => 6,
  ),
  array(
    'name' => 'Residencia López Rey &ldquo;Ahel&rdquo;',
    'location' => 'Punta del Este',
    'prefix' => 'Residencia_Lopez_Rey',
    'imgCount' => 17,
  ),
  array(
  ...
  array(
    ...
    'location' => 'Montevideo',
    'prefix' => 'Coop_Vivienda',
    'imgCount' => 2,
  ),
  array(
    'name' => 'Residencia Saulieu',
    'location' => 'Punta del Este',
    'prefix' => 'Residencia_Saulieu',
    'imgCount' => 2,
  ),
  array(
    'name' => 'Ampliación del Banco Holandés Unido',
    'location' => 'Montevideo',
    'prefix' => 'Ampliacion_Banco_Holandes_Unido',
    'imgCount' => 3,
  ),
  array(
    'name' => 'Residencia Goldfarb',
    'location' => 'Montevideo',
    'prefix' => 'Residencia_Goldfarb',
    'imgCount' => 1,
  ),
  array(
  ...
  array(
    ...
    'location' => 'Montevideo',
    'prefix' => 'Hogar_Espanol',
    'imgCount' => 1,
  ),
  array(
    'name' => 'Residencia Lecueder',
    'location' => 'Montevideo',
    'prefix' => 'Residencia_Lecueder',
    'imgCount' => 1,
  ),
  array(
  ...
  array(
    ...
    'location' => 'Montevideo',
    'prefix' => 'Mdeo_Shopping',
    'imgCount' => 1,
  ),
  array(
    'name' => 'Agencia del Banco Holandés Unido',
    'location' => 'Montevideo',
    'prefix' => 'Agencia_Banco_Holandes_Unido',
    'imgCount' => 3,
  ),
  array(
    'name' => 'Agencia del Banco Holandés',
    'location' => 'Montevideo',
    'prefix' => 'Agencia_Banco_Holandes_Bvar',
    'imgCount' => 2,
  ),
  array(
  ...
  array(
    ...
    'location' => 'Montevideo',
    'prefix' => 'Antep_Concurso_Edif_Notarial',
    'imgCount' => 1,
  ),
  array(
    'name' => 'Concurso Banco Hipotecario',
    'location' => 'Montevideo',
    'prefix' => 'Antep_Concurso_BHU',
    'imgCount' => 1,
  ),
  array(
    'name' => 'Residencia Tres Pantallas',
    'location' => 'Punta del Este',
    'prefix' => 'Antep_Resid_Tiferes',
    'imgCount' => 6,
  ),
  array(
    'name' => 'Edificio El Ombú',
    'location' => 'Montevideo',
    'prefix' => 'Antep_Edif_El_Ombu',
    'imgCount' => 5,
  ),
  array(
    'name' => 'Edificio El Emir',
    'location' => 'Punta del Este',
    'prefix' => 'Antep_Edif_El_Emir',
    'imgCount' => 1,
  ),
  array(
    'name' => 'Residencia Tres Pilares',
    'location' => 'Punta del Este',
    'prefix' => 'Antep_Resid_Punta_Del_Este',
    'imgCount' => 7,
  ),
  array(
    'name' => 'Torre continua Tiphaine',
    'location' => 'Buenos Aires',
    'prefix' => 'Torre_Continua_Tiphaine',
    'imgCount' => 2,
  ),
  array(
    'name' => 'Complejo turístico en La Paloma',
    'location' => 'Rocha',
    'prefix' => 'Complejo_Turistico_La_Paloma',
    'imgCount' => 3,
  ),
  array(
    'name' => 'Concurso Terminal de Ómnibus de Buenos Aires',
    'location' => 'Buenos Aires',
    'prefix' => 'Concurso_Terminal_Buenos_Aires',
    'imgCount' => 1,
  ),
  array(
    'name' => 'Anteproyecto Fermín Ferreira',
    'location' => 'Montevideo',
    'prefix' => 'Proy_Urban_Anteproyecto_Fermin_Ferreira',
    'imgCount' => 2,
  ),
  array(
    'name' => 'Proyecto Lobos',
    'location' => 'Punta del Este',
    'prefix' => 'Proy_Urban_Proyecto_Lobos',
    'imgCount' => 2,
  ),
  array(
    'name' => 'Ciudad Satélite Vilazar del Mar. Con Arq. Raúl Sichero Punta Yeguas',
    'location' => 'Montevideo',
    'prefix' => 'Proy_Urban_Vilazar_Del_Mar',
    'imgCount' => 2,
  ),
);
?>
  ...
  <?php foreach ($projects as $project): ?>
    <li class="project mb-4">
      <a class="card" href="#">
        ...
        <div class="card-body">
          <h3 id="project-title-<?php echo $project['prefix'] ?>" class="card-title project__name">
