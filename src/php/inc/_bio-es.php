<p>
  Nace en Montevideo, Uruguay el 15 de Abril de 1932
</p>
<p>
  Preescolar: Instituto Crandon
</p>
<p>
  Estudios primarios: Liceo Francés
</p>
<p>
  Secundaria: Liceo Rodó
</p>
<p>
  Bachillerato: Instituto Alfredo Vázquez Acevedo
</p>
<p>
  Estudios Universitarios: Facultad de Arquitectura de la Universidad de la República del Uruguay.
</p>
<p>
...
<p>
  ...
  Montevideo. El Arq. Alfredo Nebel Farini terminó esta obra.
</p>
<p>
...
<ol class="ordered-list-start">
  ...
  <li>
    <a href="#" data-project-prefix="Socaire" class="js-project">
      1961 - Residencia Socaire
    </a>
    - Punta del Este - Construye Clerc y Guerra.
  </li>
  <li>
    <a href="#" data-project-prefix="Taller_Scalone" class="js-project">
      1962 - Taller Scalone
    </a>
    - Punta del Este - Construye Clerc y Guerra.
  </li>
  ...
  <li>
    ...
    García Otero Butler y Zaffaroni S.A.
  </li>
  <li>
    1963 - Agencia Pocitos del Banco del Litoral en Avda. Brasil,
    Montevideo - Construye García Otero Butler y Zaffaroni S.A.
  </li>
</ol>
<p>
  <strong>
    <span class='lead'>
      Cartas de arquitectos enviadas al Director del Instituto Italiano de
      Cultura Don Salvatore Cándido solicitando beca en Italia:
    </span>
  </strong>
</p>
<ol>
...
<p>
  En 1963 inicia la docencia como ayudante de taller de 1º año en la
  Facultad de Arquitectura en el taller Isern que dirige el Arq. Herrán, y
  continúa desarrollando su actividad en el estudio.
  <br>
  Becado por el Gobierno Italiano a fines de 1963, viaja a Europa y
  permanece estudiando en el Politécnico de Milán. Allí estudia
  prefabricación y cálculo matemático de probabilidades de encuentro de
  piezas con el profesor Sacchi. En febrero de 1964 conoce en su estudio
  de Milán al Arq. Ernesto Rogers con quien mantiene una inolvidable
  charla, y luego visita la Torre Velasca una de las obras más singulares
  de toda su extensa trayectoria. Se radica y trabaja hasta fines de 1964
  en la ciudad de Milán. Comparte esta radicación con un valioso grupo
  cultural italiano. Entre sus integrantes, se destacan el pintor Paolo
  Schiavocampo y el escultor Pino Spagnulo.
</p>
<p>
  Es invitado para proyectar el reciclaje de un palacio del siglo XVIII en
  Piazzale Baracca de Milano. Proyecta también un conjunto de apartamentos
  y comercios en Cinisello Balsamo zona suburbana de Milán. Finalmente
  para la misma empresa desarrolla un proyecto de viviendas prefabricadas
...
<p>
  ...
  docencia como ayudante de clase en el mismo taller del Arq. Herrán en la
  Facultad de Arquitectura. Allí se reencuentra con los mismos alumnos que
  había dejado a fines de 1963, ahora cursando 3º Año. Estudiantes
  destacados: Enrique Cohe, Roberto Alberti, Oscar Corlazzoli, Juan Elbio
  Nicola, Armando González y Julio Bazzano, entre otros.
</p>
<p>
  Desde el viaje hacia Italia, en octubre de 1963, hasta su regreso a
  principios de 1965, se incorpora Alfredo Rudich al estudio de forma
  provisoria, invitado por el arquitecto López Rey. En este período se
  realiza la residencia Poyo Roc.
</p>
<p>
  A partir de 1965 el estudio va desarrollando una nueva expresión
  plástica en la que abandona, en ocasiones, el lenguaje estructural
  inicial dando lugar a la arquitectura de fuertes volúmenes blancos. Este
  lenguaje contó con la influencia de la arquitectura mediterránea del sur
  de Italia, como Ostuni, las islas griegas, Santorini, Miconos y varias
  ciudades de Andalucía. El estudio va así en busca de este nuevo lenguaje
...
<ol class="ordered-list-continue">
  ...
  <li>
    1967 - Residencia Arq. Gómez Platero - Calle Lido, Montevideo -
    Construye Puzynin.
  </li>
  <li>
  ...
  <li>
    1971 - Ampliación del Hotel Cabo Santa María con sus apartamentos,
...
<p>
  Aquel lenguaje se expresa especialmente en los Edificios El Fortín, Paz
...
<p>
  ...
  SAFEMA (Sociedad Anónima de Fomento Edilicio de Maldonado). Con su
  talento, compromiso, optimismo, honorabilidad y brillante
  profesionalismo logró importantes inversiones en momentos financieros
  muy complejos para el Uruguay- En consecuencia, gracias a su importante
  e inolvidable gestión, se pudieron construir tantas obras de gran
  calidad en Punta del Este y en Montevideo. Tuvimos la suerte de poder
  acompañarlo en su camino durante aquellos largos e inolvidables años.
  Lamentablemente, lo perdimos muy pronto, aunque su hijo, Carlos Alberto
  Lecueder, supo continuar tantas obras nuevas y de gran calidad con las
  mismas condiciones que sigue aportando en el presente.
</p>
<p>
...
<p>
  En 1976, terminado el Edificio Berna, viaja a Europa y se reencuentra
  con el pintor Paolo Schiavocampo y el escultor Pino Spagnulo,
  importantes referentes de la pintura y escultura italianas.
  <br>
  Luego viaja por Italia, Francia, España y Grecia.
</p>
<p>
...
<p>
  En el año 1975 se integra como socio financiero de SAFEMA el Sr. Goar
  Mestre, importante empresario cubano con formación en Estados Unidos, y
  creador de importantes medios de comunicación en La Habana, Caracas y
  Buenos Aires. Para nuestro estudio fue muy importante su intervención
  para el logro de la perfección en tantos detalles de nuestros proyectos.
  Se entendió estupendamente con el Cr. Luis Lecueder y con nuestro
...
<ol class="ordered-list-continue">
  ...
  <li>
    1985 - Hotel Victoria Plaza (Remodelación y nueva torre) - Construye
    Joao Fortes Ingeniería.
  </li>
</ol>
<p>
  En los últimos años contaron con excelentes colaboradores como el Arq.
  Arturo Villamil, el Arq. Tomás Sprechman, el Arq. Enrique Benech, y
...
<p>
  En 1984 se retira del estudio.
</p>
<p>
  Tratando de recuperar su salud, inicia un período de trabajos primero con
  el Bach. Luis Cano y luego con el Bach. Leo Ravera y la colaboración de
  los Bachilleres Eduardo Mazzeo y Gabriela Benítez.
</p>
<p>
  ...
  totalmente un antiguo edificio de viviendas de principios del siglo
  pasado. Desarrolla también algunas tareas menores en agencias del Banco
...
<ol class="ordered-list-continue">
  <li>
    ...
    Cano, 25 de mayo 575, Montevideo - Construye CUOPSA. Esta obra lo ayuda
    a recuperarse. Terminada la obra con éxito la Banca Nazionale del
    Lavoro adquiere el edificio. Actualmente allí funciona la Embajada de
    Chile.
  </li>
  <li>
    ...
    para "La Casa de la Exportación", con la colaboración del bachiller
  ...
  <li>
    ...
    , con la colaboración del bachiller Luis Cano.
  </li>
</ol>
<p>
  Finalmente culmina sus últimas obras con la colaboración de los Arq. Leo
  Ravera, Eduardo Mazzeo y Gabriela Benítez, iniciando un tiempo de uso del
...
<ol>
  ...
  <li>
    ...
    Perla Estable, Alberto Meijide Lavignasse, Francisco Villegas Berro,
    Mario Harispe y el bachiller Guillermo Lussich.
  </li>
</ol>
<p>
  <strong>
...
<ol>
  ...
  <li>
    ...
    Bouret, invitado por este y por el Cr. Darío Jourdan del grupo Ferrés
    y con la colaboración del Arq. Jorge Varela López.
  </li>
</ol>
<p>
...
<p>
  Fuimos grandes amigos desde la adolescencia con el Cr. Alberto Veiga De
  Cicco, y luego hasta el día de hoy con el gran amigo y gran profesional
  Cr. Daniel Veiga Dobrich quien me acompañó siempre en las buenas y en las
  malas y quien me acompañará hasta el final del camino.
</p>
<p>
